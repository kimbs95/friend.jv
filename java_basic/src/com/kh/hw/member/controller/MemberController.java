...
public class MemberController {
    ...
    public MemberController() {
        ...
        m[2] = new Member("ghi", "김철수", "6544", "ghi@naver.com", 'M', 43);
    }
...
//        return false;
        ...
        // 인덱스를 찾는 함수를 만들면 중복체크메소드를 간단하게 변경할 수 있다.
    ...
    public  Member[] searchName(String name) {
        ...
        Member[] foundMembers = new Member[100];
    ...
    public  void deleteAll() {
        // existMemberNum 을 count 변수에 넣어주지 않으면 실시간으로 변함.
        int count = existMemberNum();
        for (int i = 0; i < count; i++) {
            m[i] = null;
        }
