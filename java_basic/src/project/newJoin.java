...
public class newJoin {
   ...
   /* 성적 관리 프로그램
    ...
    static int idcnt = 0;
    // 선생님 회원가입
    static String[] teacherID = {"qq"};
    static String[] teacherPW = {"ww"};
    static String[] teacher = {"rr"}; // 선생님 이름 저장
    // 학생 회원가입
    static String[] studentID = {"aa"};
    static String[] studentPW = {"bb"};
    static String[] student = {"cc"}; //학생이름 저장
